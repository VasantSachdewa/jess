...
class TestWebsiteConfigView(TestCase):
    ...
    def test_get_invalid_id(self):
        expected_response = {"message": "id 2 do not exists"}
    ...
    def test_create_config_pass(self):
        ...
        request_body = {"name": "linkedin", "url": "https://www.linkedin.com/"}
    ...
    def test_create_config_duplicate_name_fail(self):
        expected_response = {"message": "Error creating config"}
        request_body = {"name": "jobsdb", "url": "https://www.jobsdb.com/"}
        response = self.client.post(
            "/scraper/config/",
            data=json.dumps(request_body),
            content_type="application/json",
    ...
    def test_patch_config_update_valid(self):
        ...
        request_body = {"id": 1, "url": "https://www.jobsdbpatched.com"}
    ...
    def test_delete_invalid_config(self):
        expected_response = {"message": "id 200 do not exists"}
...
class TestSyncJob(TestCase):
    ...
    def test_get_job_sync_valid_id(self, mock_kafka_producer):
        expected_response = {"message": "Started Sync"}
    ...
    def test_get_job_sync_invalid_id(self, mock_kafka_producer):
        self.assertRaises(
            InvalidScaperId, self.client.get, "/scraper/sync_jobs/?id=2000"
        )
